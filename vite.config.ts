...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.ico', 'favicon.png', 'apple-touch-icon.png', 'robots.txt', 'icon-192.png', 'icon-512.png'],
      manifest: {
      ...
      workbox: {
        ...
        navigateFallbackDenylist: [/^\/~oauth/, /^\/auth\/v1/, /^\/rest\/v1/, /^\/storage\/v1/, /^\/functions\/v1/],
